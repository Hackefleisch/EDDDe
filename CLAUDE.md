...
- Conformer fairness: all 3D methods share the same conformer ensemble. The global generator is in [eddde/data/conformers.py](eddde/data/conformers.py) — don't let any method silently generate its own.
