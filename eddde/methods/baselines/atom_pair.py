"""B5: Atom Pair fingerprint + Tanimoto distance."""
...
class AtomPair(Method):
    id = "B5"
    version = "atompair-2048-v1"
    needs = Stage.SMILES

    def __init__(self) -> None:
        self._gen = rdFingerprintGenerator.GetAtomPairGenerator(fpSize=2048)
